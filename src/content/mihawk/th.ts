...
export const mihawkThaiPilot = {
  ...
  curve: {
    eyebrow: 'ลำดับ DON!!',
    title: 'ใช้เช็กลิสต์ตาม DON!!',
    note: 'ในแต่ละระดับ ให้เลือกการ์ดที่แสดง 1 ใบ แล้วทำตามการกระทำที่ระบุ OR หมายถึงเลือก 1 ใบ ไม่ใช่ทั้งสองใบ เมื่อใช้เอฟเฟกต์ลีดเดอร์ ให้ทำตามลำดับเอฟเฟกต์ลีดเดอร์ ที่ 9–10 DON!! ให้ใช้ ปิดเกม สำหรับแผนปิดเกม',
    tag: 'เลือก 1 ใบ · OR หมายถึงเลือก 1 ใบ',
    lanes: [{ heading: 'ตัวอย่างลำดับ', turns: [
       { don: '1–4 DON!!', ids: ['OP12-034', 'OP07-022', 'OP14-039', 'OP14-023'], separators: ['OR', 'OR', 'OR'], title: 'เลือก 1 ใบ · เตรียมมือ', text: '1. เลือกการ์ดที่แสดง 1 ใบ 2. ใช้ Perona, Otama, Coffin Boat หรือ Kikunojo 3. หากใช้เอฟเฟกต์ลีดเดอร์ ให้ทำตามลำดับเอฟเฟกต์ลีดเดอร์' },
       { don: '5 DON!!', ids: ['OP07-026', 'OP10-030', 'OP12-023', 'OP14-033', 'ST32-002'], separators: ['OR', 'OR', 'OR', 'OR'], title: 'เลือก 1 ใบ · ทำเงื่อนไขให้ครบ', text: '1. เลือกการ์ดที่แสดง 1 ใบ 2. ลงตัวละคร Cost 5 ฝั่งใดฝั่งหนึ่งต้องมีตัวละคร Cost 5 หรือมากกว่า 3. หากใช้เอฟเฟกต์ลีดเดอร์ ให้ทำตามลำดับเอฟเฟกต์ลีดเดอร์' },
       { don: '6 DON!!', ids: ['ST32-003', 'OP13-031'], separators: ['OR'], title: 'เลือก 1 ใบ · ลงการ์ด', text: '1. เลือกการ์ดที่แสดง 1 ใบ 2. ใช้ ST32-003 หรือ OP13-031 ก่อนเอฟเฟกต์ลีดเดอร์ 3. ใช้เอฟเฟกต์ลีดเดอร์ แล้วทำตามลำดับเอฟเฟกต์ลีดเดอร์' },
       { don: '9 DON!!', ids: ['OP14-119', 'ST16-004'], separators: ['OR'], title: 'เลือก 1 ใบ · Cost สูง', text: '1. เลือกการ์ดที่แสดง 1 ใบ 2. ใช้ OP14-119 หรือ ST16-004 โดย Shanks K.O. ตัวละครที่พักอยู่แล้ว 3. ใช้ ปิดเกม สำหรับแผนปิดเกม' },
       { don: '10 DON!!', ids: ['ST24-004'], separators: [], title: 'เลือกการ์ดที่แสดง · ควบคุมสนาม', text: '1. เลือกการ์ดที่แสดง 2. ใช้ Law & Bepo พักตัวละคร แล้วทำให้ตัวละครนั้นไม่แอ็กทีฟใน Refresh Phase ถัดไป 3. ใช้ ปิดเกม สำหรับแผนปิดเกม' },
    ] }],
  },
  sequence: {
  ...
  finish: {
    eyebrow: 'ปิดเกม',
    title: 'ปิดเกมตามลำดับ',
    note: 'แผนปิดเกมตัวอย่าง ปรับตามมือและสนามของคุณ',
    items: [
      { ids: [], separators: [], title: '1 · พักเป้าหมายฝ่ายตรงข้าม', text: 'เริ่มด้วยการพักเป้าหมายฝ่ายตรงข้าม 1 ใบด้วยเอฟเฟกต์ที่ถูกต้อง ขั้นตอนนี้ช่วยเตรียมแผนปิดเกม' },
      { ids: ['ST16-004', 'OP14-119'], separators: ['OR'], title: '2 · เลือกแผนที่ 9 DON!!', text: 'ที่ 9 DON!! เลือก Shanks เพื่อ K.O. ตัวละครที่พักอยู่แล้ว หรือเลือก Mihawk Cost 9 เพื่อทำให้ตัวละครสำคัญของฝ่ายตรงข้ามพักไม่ได้' },
      { ids: ['ST24-004', 'OP14-020'], separators: [], title: '3 · ใช้แผนที่ 10 DON!!', text: 'ที่ 10 DON!! ใช้ Law & Bepo พักตัวละคร แล้วทำให้ตัวละครนั้นไม่แอ็กทีฟ โบนัส Power ของลีดเดอร์ต้องมีตัวละครฝ่ายตรงข้ามที่พักอยู่ 2 ใบ' },
      { ids: ['ST16-004', 'ST24-004', 'OP14-020'], separators: [], title: '4 · ใช้เอฟเฟกต์ แล้วโจมตี', text: 'ใช้เอฟเฟกต์ตัวละครให้เสร็จก่อนเอฟเฟกต์ลีดเดอร์ เอฟเฟกต์ลีดเดอร์ห้ามลงตัวละครเพิ่มในเทิร์นนี้ ใช้ DON!! ที่แอ็กทีฟเพื่อโจมตีหรือใช้อีเวนต์ Counter' },
    ],
  },
  tips: {
    eyebrow: 'คำแนะนำ',
